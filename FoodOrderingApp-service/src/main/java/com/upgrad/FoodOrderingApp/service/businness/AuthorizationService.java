...
public class AuthorizationService {
    ...
    //Need to compare with isValidActiveAuthToken later
    public void validateCustomerAccessToken(final String authorizationToken) throws AuthorizationFailedException {
